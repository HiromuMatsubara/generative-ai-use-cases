...
const lambdaConfigs = [
  ...
  { entry: 'createChat.ts' },
  { entry: 'deleteChat.ts' },
  { entry: 'createMessages.ts' },
  { entry: 'updateTitle.ts' },
  { entry: 'listChats.ts' },
  { entry: 'findChatById.ts' },
  { entry: 'listMessages.ts' },
  { entry: 'updateFeedback.ts' },
  { entry: 'getWebText.ts' },
  { entry: 'createShareId.ts' },
  { entry: 'getSharedChat.ts' },
  { entry: 'findShareId.ts' },
  { entry: 'deleteShareId.ts' },
  { entry: 'listSystemContexts.ts' },
  { entry: 'createSystemContext.ts' },
  { entry: 'updateSystemContextTitle.ts' },
  { entry: 'deleteSystemContext.ts' },
  { entry: 'deleteFile.ts' },
  { entry: 'getTokenUsage.ts' },
