...
export VITE_APP_SHAREPOINT_REDIRECT_URL=$(extract_value "$stack_output" SharepointRedirectUrl)
export VITE_APP_CLOUDFRONT_HOSTNAME=$(extract_value "$stack_output" CloudfrontHostname)
